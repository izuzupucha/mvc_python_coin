...
class ICView:
    ...
    def show(controller):
        ...
        with st.form("ic_form"):
            ...
            #)
            submitted = st.form_submit_button("🔍 Phân tích Ichimoku Cloud")
            ...
            if not coin_pair.strip():
                ...
                try:
                    ...
                    if result is not None:
                        ...
                        st.info(f"Hàm phân tích Ichimoku Cloud không có kết quả {result}")
                except Exception as e:
                    st.error(f"Hàm phân tích Ichimoku Cloud có lỗi {e}")
        st.divider()
